...
const Rate = () => {
    return (
        <div className='h-[90%] w-[90%]  flex flex-col gap-3 '>
            ...
            <div className='h-[15%]'>
                <div className=' cursor-pointer h-[100%]  font-Overpass text-center text-[.8rem] font-semibold flex justify-center items-center rounded-3xl bg-[#fb7413] text-white hover:bg-[white] hover:text-[#fb7413]'>
                    SUMBIT
                </div>
            </div>
