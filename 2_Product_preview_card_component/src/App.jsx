  ...
  return (
    <>
      <div className="h-[100vh] w-[100wh] flex justify-center items-center sm:bg-[#f2ebe3] ">
        <div className="h-[600px] w-[300px] flex flex-col  shadow-lg rounded-b-2xl sm:w-[40%] sm:h-[60%] sm:bg-[grey]  md:bg-[red] lg:bg-[yellow] xl:bg-[green]">
            ...
            <div className="h-[60%] w-[100%] flex justify-center sm:h-full border sm:rounded-r-2xl">
              <div className="h-[95%] w-[90%]  flex flex-col items-center  mt-3">
                <div className="h-[10%] w-[100%]  flex ">
                  <h1 className="text-[#6c7289] font-montserrat text-[.7rem] tracking-widest">PERFUME</h1>
                </div>
                <div className="h-[25%] w-[100%] flex sm:h-[30%] ">
                  <p className="font-bold font-fraunces text-[1.6rem] text-[#1c232b]">Gabrielle Essence Eau De Parfume</p>
                </div>
                <div className="h-[25%] w-[100%] flex ">
                  <p className="text-[.8rem] text-[#6c7289] font-md font-montserrat">A floral, solar and voluptuous iterpretation composed by Olivier Polge, Perfumer-Creator for the House of CHANEL.</p>
                </div>
                <div className="h-[15%] w-[90%]  flex gap-3 ">
                  <div className="h-[100%]  flex items-center">
                    <p className="font-fraunces text-xl text-[#3c8067]">$149.99</p>
                  </div>
                  <div className="h-[100%] flex items-center">
                    <p className="text-[.6rem] text-[#6c7289] line-through">$169.99</p>
                  </div>
                </div>
